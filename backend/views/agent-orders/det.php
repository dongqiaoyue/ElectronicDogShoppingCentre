...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="commentForm">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="agentName" type="text" class="form-control" name="agentName" required="" aria-required="true" readonly="readonly" value="<?= $info['agentName'] ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">联系电话：</label>
            <div class="input-group col-sm-7">
                <input id="phone" type="text" class="form-control" name="phone" required="" aria-required="true" readonly="readonly" value="<?= $info['phone'] ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="status" type="text" class="form-control" name="status" readonly="readonly" value="<?= $info['status']?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="agentAddr" type="text" class="form-control" name="agentAddr" required="" readonly="readonly" aria-required="true" value="<?= $info['agentAddr'] ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">快递运单号：</label>
            <div class="input-group col-sm-7">
                <input id="trackID" type="text" class="form-control" name="trackID" required="" readonly="readonly" aria-required="true" value="<?= $info['trackID'] ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="postName" type="text" class="form-control" name="postName" required="" readonly="readonly" aria-required="true" value="<?= $info['postName'] ?>">
            </div>
        </div>
    </form>
</div>
...
<script>
    ...
    function track() {
        ...
        layer.open({
            ...
            shade: 0.2,
            area: ['80%', '90%'],
            content: '/agent-orders/track?id='+ "<?=$info['ID']?>"+"&trackID="+"<?=$info['trackID']?>"
        });
        //console.log("123");
    }
</script>
