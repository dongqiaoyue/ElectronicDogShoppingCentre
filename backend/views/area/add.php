...
<div class="ibox-content">
    <form class="form-horizontal m-t" method="post" action="/area/add" id="commentForm">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="Id" type="text" class="form-control" name="Id" required="" aria-required="true" placeholder="地区ID为父级ID前四位加任意两位数字">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">父级ID：</label>
            <div class="input-group col-sm-7">
                <input id="Pid" type="text" class="form-control" name="Pid" required="" aria-required="true" value="<?= $parentID?>" disabled="disabled">
            </div>
        </div>
        <div class="form-group">
