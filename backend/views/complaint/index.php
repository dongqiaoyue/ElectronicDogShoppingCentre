            ...
            <form class="layui-form"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
                ...
                <div class="layui-input-item">
                    <div class="layui-inline">
                        <?php if(\common\helpers\Tools::authCheck('complaint/del-selected')): ?>
                        <a href="javascript:complaintDelSelected();">
...
<!--                        <th data-field="id">ID</th>-->
                        ...
                        <th data-field="title">投诉原因</th>
                        <th data-field="content">投诉内容</th>
                        <th data-field="expectation">处理期望</th>
...
<script type="text/javascript">
    ...
    function complaintDet(id) {
        layer.open({
            ...
            shade: 0.2,
            area: ['80%', '90%'],
            content: '/complaint/det?id=' + id
        });
    }
    //删除
    function complaintDel(id){
        layer.confirm('确认删除此条投诉吗?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("/complaint/del", {'id' : id}, function(res){
                if(1 == res.code){
                    layer.msg(res.msg);
                    setTimeout(function(){
                        initTable();
    ...
    function complaintDelSelected() {
        layer.confirm('确认删除所选投诉信息?', {icon: 3, title:'提示'}, function(index) {
            ...
            $.getJSON("/complaint/del-selected", {'ids' : ids}, function(res){
                if(1 == res.code){
                    layer.msg(res.msg);
                    setTimeout(function(){
                        initTable();
