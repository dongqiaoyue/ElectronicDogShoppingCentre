...
<div class="ibox-content">
    <form class="form-horizontal m-t" method="post" action="/dictionary/edit" id="commentForm">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-sm-7">
                <input id="Code" type="text" class="form-control" name="Code" required="" aria-required="true" value="<?= $info['Code'] ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">所属字典：</label>
            <div class="input-group col-sm-7">
                <select class="form-control" name="parentID" required="" aria-required="true">
                    <option value="0" <?php if(0 == $info['parentID']): ?> selected <?php endif; ?>>顶级字典</option>
