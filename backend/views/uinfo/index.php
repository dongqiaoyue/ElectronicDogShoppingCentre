    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div  class="form-group clearfix col-sm-1">
                <?php if(\common\helpers\Tools::authCheck('uinfo/add')): ?>
                <a href="javascript:uinfoDelSelected();">
...
<script type="text/javascript">
    ...
    //批量删除
    function uinfoDelSelected() {
        layer.confirm('确认删除这些用户?', {icon: 3, title:'提示'}, function(index) {
            var ids = "";
    ...
    function uinfoDet(id){
        layer.open({
            ...
            shade: 0.2,
            area: ['80%', '45%'],
            content: '/uinfo/det?id=' + id
        });
    }

    function uinfoDel(id){
        layer.confirm('确认删除此用户?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("/uinfo/del", {'id' : id}, function(res){
                if(1 == res.code){
                    layer.msg(res.msg);
                    setTimeout(function(){
                        initTable();
